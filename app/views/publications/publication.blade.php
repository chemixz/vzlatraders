             ...
             <div class="panel panel-custom  public_box"  style="border-color: {{$P->category->codecolor}}"> 
                ...
                <div class=" public_box_actions">
                   <p>
                    ...
                    @endif
                    <a href="#" class="btn btn-warning "  data-toggle="tooltip" data-placement="top" title="Intercambios"><span class="glyphicon glyphicon-random" style="font-size: 15px; "></span> <span class="badge"><span style="color: black;"> {{ count($P->exchanges()->where('user_id','=', $P->user->id)->get() ) }} </span></span></a>
