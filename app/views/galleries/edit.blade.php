...
@section('content')
     <div class="row" ng-app="angularFront">
        <div class="col-xs-12 col-md-6 center-block no-float" ng-controller="Profile_Controller">
                ...
                @endif
                    {{ Form::open(['url'=>'/galleries/update/'.$gallery->id,'method'=>'post', 'file'=>true, 'enctype' => 'multipart/form-data']) }}
                      ...
                      <div class="" style="padding-left:0">
                        ...
                        <div class="">
                          <div class="thumbnail" style="overflow:hidden;">
                            <div id="target">
                				<img width="100%" src="{{URL::to('/')}}/uploads/images/galleries/{{$gallery->picture}}" class="img-responsive">
                            </div>
                            <br>
